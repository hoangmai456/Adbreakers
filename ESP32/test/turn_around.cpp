...
void swingLegs(legIndex legA, legIndex legB) {
    moveTwoLegs(legA, 90, 120, 180, 120, legB, 90, 120, 180, 120, 2);
    delay(100);
    moveTwoLegs(legA, 120, 50, 120, 180, legB, 120, 50, 120, 180, 2);
    delay(100);
}
...
void loop() {
    ...
    delay(150);
    moveTwoLegs(legs[0], 90, 50, 180, 140, legs[2], 90, 50, 180, 140, 2);
    delay(150);
    moveTwoLegs(legs[1], 120, 50, 120, 180, legs[3], 120, 50, 120, 180, 2);
    delay(150);
    moveTwoLegs(legs[0], 50, 120, 140, 180, legs[2], 50, 120, 140, 180, 2);
    delay(150);
}
